...
const socialLinks = [
  {
    href: 'https://github.com/Mohamed-Nabil-Pro',
  ...
  {
    href: 'https://www.linkedin.com/in/mohamed-nabil-678018353/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/mohamed33nabil/',
...
const Contact = () => {
  return (
    <section id="contact">
        <div className='container mx-auto px-4 md:px-8 xl:max-w-6xl pt-20 grid md:grid-cols-2 md:items-stretch'>
            <div className="mb-12 md:mb-0 ">
                <h2 className="md:text-5xl text-4xl leading-tight font-semibold md:text-[55px] md:leading-[1.15] bg-gradient-to-r from-[#fafafa] to-[#a1a1aa] bg-clip-text text-transparent mb-8 md:mb-10 md:max-w-[12ch]">Contact me for collaboration</h2>
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] md:max-w-[30ch]">Reach out today to discuss your project needs and start collaborating on something amazing!</p>
                <div className="flex items-center gap-2 mt-auto">
                    {
                        socialLinks.map((link, index) => (
                            <a 
                                ...
                                className="size-12 grid place-items-center ring-2 ring-zinc-50/5 rounded-lg transition-all hover:bg-zinc-300  hover:text-zinc-950 active:bg-zinc-50/80  duration-300"
                            >
                                {link.icon}
                            </a>
                        ))
            ...
            <form action="https://getform.io/f/avrmpvra" method="post" className="md:pl-10" >
                <div>
                    <div>
                        <label htmlFor="name">Name</label>
                        <input type="text" id="name" name="name" placeholder="Enter your name" required className='w-full   p-3 mt-2 mb-4 rounded-lg bg-zinc-800 border border-zinc-700 focus:border-sky-400 outline-none'/>
                    </div>

                    <div>
                        <label htmlFor="email">Email</label>
                        <input type="email" id="email" name="email" placeholder="Enter your email" required className='w-full   p-3 mt-2 mb-4 rounded-lg bg-zinc-800 border border-zinc-700 focus:border-sky-400 outline-none'/>
                    </div>
                </div>
                ...
                <button type="submit" className="w-full  mb-4 flex justify-center items-center font-semibold text-xl gap-3 h-11 bg-zinc-400 text-zinc-950 hover:bg-zinc-300 active:bg-sky-400 px-6 rounded-full">Submit</button>
            </form>
        </div>
    </section>
  )
