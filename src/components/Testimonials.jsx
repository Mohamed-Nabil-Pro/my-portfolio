...
const TestimonialsSection = () => {
  return (
    <section id="testimonials" className="py-16 px-4 max-w-7xl mx-auto container  md:px-8 xl:max-w-6xl pt-20">
        <div className="text-center mb-4">
            <h2 className="bg-gradient-to-r from-[#fafafa] to-[#a1a1aa] bg-clip-text text-transparent text-4xl md:text-5xl font-semibold leading-tight mb-4">What our happy client say</h2>
            <p className="text-zinc-300">Things that make it the best place to start trading</p>
        </div>
                        ...
                        <SwiperSlide key={index} className='!h-auto md:py-12  py-4'>
                            <div className='bg-zinc-800/50 text-center p-4 h-full flex flex-col rounded-lg shadow-lg'>
                                <div className='size-24 mx-auto mb-4'>
                                    <img src={testimonial.image} alt="testimonial image" className='w-20 h-20  object-cover rounded-full'/>
                                </div>
                                {/* testimonial stars */}
